...
public class PizzaApp {
	 ...
	 public static void main(String[] args) throws CloneNotSupportedException {
			...
			System.out.println(samePizza.getClass().getSimpleName());
			System.out.println(samePizza.getClass().getName());
			System.out.println(samePizza.getClass().getFields());
			System.out.println(samePizza.getClass().getDeclaredFields());
			System.out.println(samePizza.getClass().getMethods());
			System.out.println(samePizza.getClass().getDeclaredMethods());
			System.out.println(samePizza.getClass().getSuperclass());
